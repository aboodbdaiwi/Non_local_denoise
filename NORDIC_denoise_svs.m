function  NORDIC_denoise_svs(fn_magn_in,fn_phase_in,fn_out,ARG,pathw,newkernel)
% fMRI
...
%save([pathw,'inter.mat'],'KSP2','gfactor','ARG','-v7.3')
...
disp('starting nonlocal  ...')

denoise_image_all=denoise_nonlocal_svs(KSP2,abs(IMG2),newkernel);

IMG2 = denoise_image_all;
disp('completing  nonlocal  ...')
for n=1:size(IMG2,4);
    IMG2(:,:,:,n)= IMG2(:,:,:,n).* gfactor;
end
